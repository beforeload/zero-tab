# AGENTS.md -- Zero Tab: Setup & Onboarding Guide for Coding Agents

You're installing **Zero Tab** for the user. Your job is not just to set it up -- it's to get them excited about using it.
...
> You're all set! Open a **new tab** and you'll see Zero Tab.
>
> Here's how it works:
